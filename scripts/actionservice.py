...
class TrajectoryActionClient(Node):
	...
	def __init__(self):
		...
		self.action_client = ActionClient (self, FollowJointTrajectory, '/robot_cam_controller/follow_joint_trajectory')
	...
	def send_goal(self):
		...
		point1_msg.positions = [0.0, 0.0 ]
		point1_msg.time_from_start = Duration(seconds=0.0).to_msg()

		point2_msg = JointTrajectoryPoint()
		point2_msg.positions=[0.0, 0.5] 
		point2_msg.time_from_start = Duration(seconds=2, nanoseconds=0).to_msg()

		point3_msg = JointTrajectoryPoint()
		point3_msg.positions=[0.5, 0.5] 
		point3_msg.time_from_start = Duration(seconds=4, nanoseconds=0).to_msg()

		point4_msg = JointTrajectoryPoint()
		point4_msg.positions=[0.5, -0.5] 
		point4_msg.time_from_start = Duration(seconds=6, nanoseconds=0).to_msg()

		point5_msg = JointTrajectoryPoint()
		point5_msg.positions=[-0.5, -0.5] 
		point5_msg.time_from_start = Duration(seconds=8, nanoseconds=0).to_msg()
  
		point6_msg = JointTrajectoryPoint()
		point6_msg.positions=[0.5, 0] 
		point6_msg.time_from_start = Duration(seconds=10, nanoseconds=0).to_msg()
		...
		joint_names = ['camera_pan_joint','camera_tilt_joint']
